              ...
              >
                ...
                {shouldShowProButton(comparison.llm) ? (
                  <button
                    ...
                    className="px-4 py-1.5 bg-white text-black text-xs font-medium hover:opacity-90 transition-all duration-150 rounded-md active:scale-95"
                  >
                    Pro
                  </button>
                ) : (
