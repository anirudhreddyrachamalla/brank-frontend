      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-10 md:py-12 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-10 sm:mb-16">
          {[
            ...
            <Reveal key={metric.label} delay={baseDelay + index * stagger} duration={0.9} y={14}>
              <MetricCard
                label={metric.label}
                value={metric.value}
                info={metric.info}
        ...
        <div className="space-y-6 sm:space-y-8 mb-10 sm:mb-16">
          {[
            ...
            <Reveal key={card.title} delay={baseDelay + index * stagger} duration={0.95} y={16}>
              <ComparisonCard
                title={card.title}
        ...
        {/* Ranking Overview */}
        <Reveal delay={baseDelay} duration={1.0} y={18}>
              ...
              <div className="pl-0 md:pl-12">
                ...
                <div className="space-y-4">
                  {mockAnalyticsData.rankings.byLLMs.llms.map((llm, index) => (
                    <Reveal
                      key={llm.name}
                      delay={baseDelay + 0.08 + index * 0.06}
                      duration={0.6}
                      y={10}
                    >
        ...
        {/* Citation Overview */}
        <div className="mb-10 sm:mb-16">
          <Reveal delay={baseDelay} duration={0.9} y={14}>
          ...
          {/* AI Insight */}
          <Reveal delay={baseDelay + stagger} duration={0.95} y={16}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {mockAnalyticsData.citations.llms.map((llm, index) => (
              <Reveal
                key={llm.name}
                delay={baseDelay + stagger * 2 + index * stagger}
                duration={0.95}
                y={16}
              >
